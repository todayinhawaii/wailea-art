  ...
  <tr>
    <td align="center" style="padding:32px 16px;">
      ...
      <table role="presentation" class="email-wrap" width="600" cellpadding="0" cellspacing="0" style="width:600px; max-width:600px; background-color:#fdfaf3; border:1px solid #e2d5ab;">
        ...
        <tr>
          <td align="center" class="stack-pad" style="padding:8px 48px 20px;">
            <p style="margin:0; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:15px; line-height:1.7; color:#6b6255;">
              ...
              from museum-quality prints to gallery canvases. Every piece is hand-designed, printed on
              premium materials, and shipped right from the islands. We work directly with a small
              number of shops, galleries, and hotels who share our love for the islands, and we'd be
              glad to talk with you too. Here's a small taste of the collection below.
            </p>
          </td>
        </tr>
