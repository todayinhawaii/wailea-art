...
async function draftOutreachEmail(lead) {
  ...
  const prompt = `You are writing a short, warm, professional wholesale outreach email on behalf of Wailea Art, a small family-run art studio based in Wailea, Maui that creates original Hawaii-inspired art prints (former Hollywood creative directors who now paint the islands). The email is being sent to a real business that might want to carry Wailea Art prints in their shop, gallery, or hotel.

Here is what's known about the recipient:
Business name: ${lead.business_name}
Location: ${lead.location}
Contact person: ${lead.contact_name || 'not known — use a general greeting'}
Business type: ${lead.business_type}
Why this business is a good fit: ${lead.why_fit}

Write a short outreach email (under 150 words) that:
- Opens with a warm, specific, non-generic greeting (use their contact name if known)
- Naturally references something specific about their business (not just their name — show real familiarity)
- Briefly introduces Wailea Art and what makes the work distinctive (original Hawaii art, museum-quality prints, bulk/wholesale pricing available)
- Ends with a low-pressure, specific call to action (e.g., offering to send a small sample pack or a wholesale price sheet)
